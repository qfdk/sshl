...
export function Sidebar({ manager }: { manager: ConnectionManager }) {
  ...
  return (
    <aside className={`flex h-full min-h-0 shrink-0 select-none flex-col overflow-hidden border-r border-border bg-card transition-[width] duration-200 ${collapsed ? 'w-16' : 'w-52'}`} id="sidebar" data-collapsed={collapsed}>
