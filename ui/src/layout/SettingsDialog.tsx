              ...
              <Card className="border-border/80 shadow-sm">
                ...
                <form id="group-manager-form" onSubmit={saveGroups}>
                  <CardContent className="grid gap-6">
                    ...
                    <div className="grid gap-2"><div className="text-sm font-medium">已有分组</div><div id="group-manager-groups" className="grid max-h-56 gap-2 overflow-y-auto pr-1" onPointerUp={() => setDraggedGroup(null)} onPointerCancel={() => setDraggedGroup(null)}>
