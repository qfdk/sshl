...
export function getConnectionDialogOpen() { return connectionDialogOpen; }
...
export function getEditingConnection() { return editingConnection; }
...
export function getSettingsDialogOpen() { return settingsDialogOpen; }
